...
questions[0][0] = "Which is used to find and fix bugs in the Java programs.?";
            ...
            opt4.setEnabled(true);
             ...
             ans_given=1;
                if(groupbtn.getSelection()==null){
                   ...
                   user_ans[count][0]=groupbtn.getSelection().getActionCommand();
               }
    ...
    public Quiz(JLabel qno, JLabel question, JRadioButton opt1, JRadioButton opt2, JRadioButton opt3, JRadioButton opt4) throws HeadlessException {
        this.qno = qno;
